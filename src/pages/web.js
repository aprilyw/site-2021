...
const WebPage = () => {
  ...
  <>
    ...
    <div>
        ...
        <a className="mx-2 underline hover:text-indigo-400" href="https://3dl.cs.uchicago.edu">Threedle (3DL) Lab<GoLinkExternal className="inline-block opacity-25 -mt-3px" /></a>
    </div>
    </div>
  </>
